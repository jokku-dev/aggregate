...
fun ForgotPasswordScreen(
    ...
    ForgotPasswordScreenContent(
        ...
        onButtonClick = {
            if (email.isNotEmpty())
                navController.navigate(route = dev.aggregate.app.presentation.navigation.Screen.Verification.withArgs(email))
        },
        onBottomTextClick = {
...
fun ForgotPasswordScreenContent(
    ...
    dev.aggregate.app.ui.CommonColumn {
        ...
        dev.aggregate.app.ui.HelpBottomText(
            questionText = androidx.compose.ui.res.stringResource(id = dev.aggregate.app.R.string.remember_the_password),
