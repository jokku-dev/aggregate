...
import dev.jokku.designsystem.theme.GreyLight
import dev.jokku.ui.ArticleTopBar
import kotlin.apply
...
fun ArticleScreen(
    ...
    viewModel: dev.jokku.aggregate.NewsViewModel = hiltViewModel<dev.jokku.aggregate.BaseNewsViewModel>(),
    ...
    var currentScreen by androidx.compose.runtime.remember {
        androidx.compose.runtime.mutableStateOf(
            dev.jokku.aggregate.presentation.navigation.Screen.ArticleScreen.route
        )
    }
    ...
    androidx.compose.runtime.LaunchedEffect(key1 = currentScreen) {
        if (currentScreen == dev.jokku.aggregate.presentation.navigation.Screen.ArticleScreen.route) {
...
fun ArticleScreenContent(
    article: dev.jokku.aggregate.presentation.model.UiArticle,
    onBackClick: () -> Unit,
        ...
        Column(
            ...
            Row(
                ...
                IconButton(onClick = onBackClick) {
                    Icon(
                        ...
                        contentDescription = androidx.compose.ui.res.stringResource(id = dev.jokku.aggregate.R.string.navigate_back),
                ...
                Row {
                    IconButton(onClick = onShareClick) {
                        Icon(
                            imageVector = androidx.compose.ui.graphics.vector.ImageVector.vectorResource(id = dev.jokku.aggregate.R.drawable.ic_share),
                            contentDescription = androidx.compose.ui.res.stringResource(id = dev.jokku.aggregate.R.string.share),
                            tint = androidx.compose.ui.graphics.Color.White
                        )
                    }
                    IconButton(onClick = onBookmarkClick) {
                        Icon(
                            imageVector = if (bookmarked) androidx.compose.ui.graphics.vector.ImageVector.vectorResource(id = dev.jokku.aggregate.R.drawable.ic_bookmark_selected)
                            else androidx.compose.ui.graphics.vector.ImageVector.vectorResource(id = dev.jokku.aggregate.R.drawable.ic_bookmark),
                            contentDescription = if (bookmarked) androidx.compose.ui.res.stringResource(
                                id = dev.jokku.aggregate.R.string.bookmarked
                            )
            ...
            Column(
                ...
                Column {
                    ...
                    Text(
                        text = androidx.compose.ui.res.stringResource(dev.jokku.aggregate.R.string.author),
                        style = typography.labelMedium,
                        color = dev.jokku.designsystem.theme.GreyLight
                    )
                }
            }
        }
...
fun ArticleScreenPreview() {
    dev.jokku.designsystem.theme.AggregateTheme {
        ArticleScreenContent(
            article = dev.jokku.aggregate.presentation.model.UiArticle(
                source = dev.jokku.aggregate.presentation.model.UiArticleSource(name = "The Washington Post"),
                author = "Oliver Darcy",
