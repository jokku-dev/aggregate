...
fun BottomBar(
    ...
    val items = listOf(
        dev.jokku.aggregate.presentation.navigation.Screen.Favorites,
        dev.jokku.aggregate.presentation.navigation.Screen.TopHeadlines,
        dev.jokku.aggregate.presentation.navigation.Screen.Sources,
        dev.jokku.aggregate.presentation.navigation.Screen.Bookmarks,
        dev.jokku.aggregate.presentation.navigation.Screen.Profile
    )
