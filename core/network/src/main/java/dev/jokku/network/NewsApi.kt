package dev.jokku.network

import androidx.annotation.IntRange
import com.skydoves.retrofit.adapters.result.ResultCallAdapterFactory
import dev.jokku.network.model.Category
import dev.jokku.network.model.Country
import dev.jokku.network.model.Language
import dev.jokku.network.model.NetworkArticle
import dev.jokku.network.model.NetworkSource
import dev.jokku.network.model.NetworkSourcesResponse
import dev.jokku.network.model.NetworkArticlesResponse
import dev.jokku.network.model.SearchIn
import dev.jokku.network.model.SortBy
import dev.jokku.network.util.NewsApiKeyInterceptor
