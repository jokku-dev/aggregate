...
import dev.aggregate.data.sync.Synchronizer.sync
import dev.aggregate.data.sync.syncForegroundInfo
...
class SyncWorker @dagger.assisted.AssistedInject constructor(
    ...
    @dev.aggregate.app.common.network.di.Dispatcher(dev.aggregate.app.common.network.di.NewsDispatchers.IO) private val ioDispatcher: CoroutineDispatcher
