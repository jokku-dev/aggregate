...
import dev.jokku.newsdata.PreferencesRepository
...
class SyncWorker @dagger.assisted.AssistedInject constructor(
    ...
    @dagger.assisted.Assisted private val workerParameters: WorkerParameters,
    private val preferencesRepository: PreferencesRepository,
    private val newsRepository: NewsRepository,
    @dev.jokku.aggregate.di.Dispatcher(dev.jokku.aggregate.di.NewsDispatchers.IO) private val ioDispatcher: CoroutineDispatcher
    ...
    companion object {
        fun startUpSyncWork() = OneTimeWorkRequestBuilder<DelegatingWorker>()
            ...
            .setConstraints(dev.jokku.aggregate.data.sync.SyncConstraints)
