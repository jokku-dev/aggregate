...
import com.jokku.aggregate.data.local.database.entity.TopHeadlines
import com.jokku.aggregate.data.local.database.entity.intermediate.TopHeadlinesResponseWithArticles
...
) : FromRemoteMapper<TopHeadlinesResponseWithArticles<TopHeadlines>> {
